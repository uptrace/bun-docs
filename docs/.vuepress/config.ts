  ...
  plugins: [
    ...
    redirectPlugin({
      ...
      config: {
        ...
        '/hooks/index.html': '/guide/hooks.html',
        '/sql-null-go-zero-values/index.html': '/guide/models.html',
        '/placeholders/index.html': '/guide/models.html',
        '/models/index.html': '/guide/models.html',
        '/orm/intro/index.html': '/guide/golang-orm.html',
        '/orm/has-one-relation/index.html': '/guide/relations.html',
        '/orm/many-to-many-relation/index.html': '/guide/relations.html',
        '/orm/belongs-to-relation/index.html': '/guide/relations.html',
        '/faq/index.html': '/guide/golang-orm.html',
        '/extra-modules/index.html': '/guide/performance-monitoring.html',
        '/table-partitioning/index.html': '/postgres/table-partition.html',
        '/queries.html': '/guide/queries.html',
      },
    }),
